...
# 启动web（其他目录）
npx tsx src/cli.ts -l --project /Users/ligf/工作/Code/平台/ccmodeling/platform_ai/0011
npx tsx src/cli.ts -l --project /Users/ligf/工作/Code/平台/ccmodeling/platform_ai/x_0338
